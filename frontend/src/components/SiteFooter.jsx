    ...
    <footer id="contact" className="site-footer">
      <div className="site-footer__inner">
        ...
        <div className="site-footer__socials">
          ...
          <a className="site-footer__social" href="tel:+917387338634" aria-label="Call">
        ...
        <div className="site-footer__contact-line">
          Phone: <a href="tel:+917387338634">+91-7387338634</a> | <a href="mailto:info@sawaricabs.in">info@sawaricabs.in</a>
        </div>
